...
# the above lines 28 - 34 bring the sound from the file 
...
def draw_grid(clicks, beat, actives):
    ...
    active = pygame.draw.rect(screen, blue,
                              ...
                              5, 3)
    return boxes
# the above code draws the grid for the beat maker
...
def play_notes():
    for i in range(len(clicked)):
        if clicked[i][active_beat] == 1:
            ...
            if i == 5:
                tom.play()
# this code above is what makes the notes play            
...
# this code above draws the box that will save the beat
# the cof=de below draws the box that loads saved beats
